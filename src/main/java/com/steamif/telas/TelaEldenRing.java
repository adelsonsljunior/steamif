 ...
 * @author CAYO
 */
public class TelaEldenRing extends javax.swing.JFrame {

    /**
     * Creates new form TelaHollowKnight
     */
    public TelaEldenRing() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/steamif/telas/imagens/ELDEN RING.png"))); // NOI18N
        ...
        jLabel8.setText("DATA DE LANÇAMENTO: 24/fev./2022 ");
        ...
        jLabel9.setText("DESENVOLVEDOR:  FromSoftware Inc.");
        ...
        jLabel10.setText("ELDEN RING");
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 20, -1, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI Black", 0, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(204, 255, 255));
        jLabel6.setText("nas Terras Intermédias.");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 150, -1, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI Black", 0, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(204, 255, 255));
        jLabel5.setText("poder do Anel Prístino e se tornar um Lorde Prístino");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 130, -1, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI Black", 0, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(204, 255, 255));
        jLabel4.setText("Maculado, e seja guiado pela graça para portar o");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 110, -1, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI Black", 0, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(204, 255, 255));
        jLabel3.setText("O NOVO RPG DE AÇÃO E FANTASIA. Levante-se,");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaEldenRing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
