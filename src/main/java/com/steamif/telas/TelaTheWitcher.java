 ...
 * @author CAYO
 */
public class TelaTheWitcher extends javax.swing.JFrame {

    /**
     * Creates new form TelaHollowKnight
     */
    public TelaTheWitcher() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton2.setText("Voltar ao catálogo");
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton2ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 520, -1, -1));

        jLabel12.setFont(new java.awt.Font("Segoe UI Black", 0, 12)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(204, 255, 255));
        jLabel12.setText("Criança da Profecia — uma arma viva que pode");
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 260, 180, -1));

        jLabel10.setFont(new java.awt.Font("Showcard Gothic", 0, 24)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 255, 255));
        jLabel10.setText("THE WITCHER");
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 20, -1, -1));

        jLabel7.setFont(new java.awt.Font("Segoe UI Black", 0, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(204, 255, 255));
        jLabel7.setText("alterar a forma do mundo.");
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 180, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/steamif/telas/imagens/The Witcher.png"))); // NOI18N
        ...
        jLabel8.setText("DATA DE LANÇAMENTO: 18/mai./2015");
        ...
        jLabel9.setText("DESENVOLVEDOR:   CD PROJEKT RED");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaTheWitcher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
